...
int compute_(taco_tensor_t *C, taco_tensor_t *A, taco_tensor_t *B, taco_tensor_t *Cd, taco_tensor_t *Ad, taco_tensor_t *Bd) {
  ...
  for (int32_t i1A = A1_pos[0]; i1A < A1_pos[1]; i1A++) {
    int32_t i1 = A1_crd[i1A];
    for (int32_t k1 = 0; k1 < B1_dimension; k1++) {
      int32_t k1A = i1A * A2_dimension + k1;
      int32_t k0A = k1A;
      int32_t pA3_end = k1A + 1;

      while (k0A < pA3_end) {
        int32_t k0 = A3_crd[k0A];
        int32_t k0B = k1 * B2_dimension + k0;
        int32_t A3_segend = k0A + 1;
        while (A3_segend < pA3_end && A3_crd[A3_segend] == k0) {
          A3_segend++;
        }
        for (int32_t i0 = 0; i0 < A4_dimension; i0++) {
          int32_t i0C = i1 * C2_dimension + i0;
          int32_t i0A = k0A * A4_dimension + i0;
          for (int32_t j1 = 0; j1 < B3_dimension; j1++) {
            ...
            for (int32_t j0 = 0; j0 < B4_dimension; j0++) {
              ...
              C_vals[j0C] = C_vals[j0C] + A_vals[i0A] * B_vals[j0B];
