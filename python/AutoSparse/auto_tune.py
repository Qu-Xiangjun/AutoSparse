...
def ALL_ANNS_Searching(
    ...
    **kwargs
    ...
    if save_best_trace:
        ...
        if not os.path.exists(filepath):
            os.makedirs(filepath)
        filepath = os.path.join(filepath, "all_anns_searching_{}".format(
            datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S.csv')
        ))
        with open(filepath, 'w', newline='') as file:
            writer = csv.writer(file)
...
# Batch ALL_ANNS method
def Batch_ALL_ANNS_Searching(
    schedule: Schedule,
    func: Build,
    agent_group: DQNAgentGroup,
    population_size: int = 10,
    ...
    **kwargs
    ...
    """Only using batch ALL_ANNS method"""
    print("**************** Start Batch ALL_ANNS Search ****************")
    print(f"population_size         ={population_size}")
    print(f"trial                   ={trial}")
    print(f"early_stop              ={early_stop}")
    print(f"use_performance_model   ={use_performance_model}")
    ...
    if save_best_trace:
        ...
        if not os.path.exists(filepath):
            os.makedirs(filepath)
        filepath = os.path.join(filepath, "batch_all_anns_searching_{}".format(
            datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S.csv')
        ))
        with open(filepath, 'w', newline='') as file:
            writer = csv.writer(file)
    ...
    **kwargs
    ...
    if save_best_trace:
        ...
        if not os.path.exists(filepath):
            os.makedirs(filepath)
        if use_sa:
            filepath = os.path.join(filepath, "rl_sa_searching_{}".format(
                datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S.csv')
            ))
        else:
            filepath = os.path.join(filepath, "rl_searching_{}".format(
                datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S.csv')
            ))
        with open(filepath, 'w', newline='') as file:
            writer = csv.writer(file)
...
def AutoTune(
    ...
    **kwargs
    ...
    method: str optinal("random_searching)
        method include:
        "random_searching", "all_anns_searching", "batch_all_anns_searching",
        "sa_searching", "rl_searching", "rl_sa_searching"
    ...
    elif method == "all_anns_searching":
        indices, value = ALL_ANNS_Searching(
            schedule = sch,
            func=func,
            agent_group=agent_group,
            population_size=population_size,
    ...
    elif method == "batch_all_anns_searching":
        indices, value = Batch_ALL_ANNS_Searching(
            schedule = sch,
            func=func,
            agent_group=agent_group,
            population_size=population_size,
    ...
    elif method == "rl_searching":
        indices, value = RL_Searching(
            schedule = sch,
            func=func,
            agent_group=agent_group,
            population_size=population_size,
    ...
    elif method == "rl_sa_searching":
        indices, value = RL_SA_Searching(
            schedule = sch,
            func=func,
            agent_group=agent_group,
            population_size=population_size,
