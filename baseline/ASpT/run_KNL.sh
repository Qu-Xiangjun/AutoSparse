...
# 在 SpMM_KNL_SP_preprocessing.out 文件中添加表头
...
# 在 SpMM_KNL_SP.out 文件中添加换行符
echo >> SpMM_KNL_SP.out
# 在 SpMM_KNL_SP_preprocessing.out 文件中添加换行符
